...
# Define subject and professor information
subject_name = "Facial Expression Recognition"
subject_code = "AI101"
professor_name = "Bhavik Gandhi"

# Update this path to the actual location of your model file
model_file_path = 'nis_model.h5'
data_path = 'data.csv'
...
if not os.path.exists(model_file_path):
    ...
    class_labels = sorted(data['label'].unique())
        ...
        for uploaded_file in uploaded_files:
            with st.spinner(f'Processing {uploaded_file.name}...'):
                try:
                    ...
                    # Collect results for CSV download
                    results.append({
